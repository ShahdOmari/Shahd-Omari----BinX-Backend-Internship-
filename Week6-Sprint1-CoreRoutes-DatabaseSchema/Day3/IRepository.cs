...
public interface IRepository<T> where T : class
{
    ...
    // Exposes a queryable source for callers that need to filter, sort, or
    // paginate before executing — GetAllAsync alone can't support that
    // without pulling the entire table into memory first.
    IQueryable<T> Query();
