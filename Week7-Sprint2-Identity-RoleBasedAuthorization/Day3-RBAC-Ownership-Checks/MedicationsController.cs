...
public class MedicationsController : ControllerBase
{
    ...
    // Any authenticated staff member can view medication records —
    // including Auditor, whose entire role is reviewing exactly this
    // kind of clinical data for compliance purposes.
    [HttpGet]
    ...
    // Prescribing, changing or removing medication is a clinical decision
    // that must stay with a Doctor (or Admin for system-level correction) —
    // a Nurse recording vitals should never be able to alter a prescription.
