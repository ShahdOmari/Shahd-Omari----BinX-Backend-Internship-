...
public class AppointmentsController : ControllerBase
{
    ...
    // Any authenticated staff member can view the appointment schedule —
    // routine coordination work, not a privileged action.
    [HttpGet]
    ...
    // Cancelling/removing an appointment entirely was previously open to
    // any authenticated user — tightened here so only Doctor and Admin
    // can delete, consistent with how Patients and Medications deletion
    // is restricted elsewhere in the API.
